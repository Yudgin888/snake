...
public class CreateGame {
    ...
    public static void load() {
        ...
        if (fl.exists()) {
            try {
                ObjectInputStream in = new ObjectInputStream(Files.newInputStream(Paths.get("Resource\\score")));
    ...
    public static void save() {
        ...
        try {
            ...
            ObjectOutputStream out = new ObjectOutputStream(Files.newOutputStream(Paths.get("Resource\\score")));
...
class Continue implements Serializable {
    ...
    private final int kolH;
    private final int kolB;
    ...
    public void save() {
        ...
        try {
            ...
            ObjectOutputStream out = new ObjectOutputStream(Files.newOutputStream(Paths.get("Resource\\save")));
    ...
    public static void load() {
        ...
        if (fl.exists()) {
            try {
                ObjectInputStream in = new ObjectInputStream(Files.newInputStream(Paths.get("Resource\\save")));
